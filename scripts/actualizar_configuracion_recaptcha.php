<?php
/**
 * Actualizador de configuración de Google reCAPTCHA.
 * Uso: php scripts/actualizar_configuracion_recaptcha.php
 */
...
$sqlPath = __DIR__ . '/../base_datos/actualizaciones/actualizacion_configuracion_recaptcha_admin.sql';
$logPath = __DIR__ . '/../base_datos/actualizaciones/actualizacion_configuracion_recaptcha_admin.log';
...
try {
    ...
    echo "[INFO] Iniciando actualización de configuración reCAPTCHA...\n";
    echo "[INFO] Base de datos objetivo: {$config['nombre']}\n";
