...
<section class="py-5 border-bottom bg-light-subtle">
    <div class="container">
        ...
        <div class="row g-3">
            ...
            <div class="col-12 col-md-6 col-lg-3"><figure class="landing-shot-card mb-0"><a href="<?= e($capturaConFallback(['Configuración de correos de stock.png', 'Configuración correos stock.png'])) ?>" class="landing-shot-link js-captura-ampliable" data-captura-title="Alertas de stock"><img src="<?= e($capturaConFallback(['Configuración de correos de stock.png', 'Configuración correos stock.png'])) ?>" alt="Configuración de alertas de stock por correo" loading="lazy"></a><figcaption>Alertas de stock</figcaption></figure></div>
        </div>
    </div>
</section>
