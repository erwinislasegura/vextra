...
?>
<style>
  .catalogo-topbar{background:#ffffff;border-bottom:1px solid #e9edf3;position:sticky;top:0;z-index:30;backdrop-filter:saturate(160%) blur(6px)}
  ...
  .catalogo-hero{background:radial-gradient(circle at 5% 0%,#4c1d95 0%,#1e3a8a 42%,#0f172a 100%);color:#fff;padding:2.2rem 0 2.6rem}
  ...
  .catalogo-slider{position:relative;border-radius:1.2rem;overflow:hidden;min-height:340px;background:linear-gradient(130deg,rgba(59,130,246,.35),rgba(76,29,149,.85));box-shadow:0 1rem 2rem rgba(15,23,42,.3)}
  ...
  .catalogo-filtros{margin-top:-1.2rem;position:relative;z-index:4}
  .catalogo-filtros__card{border:1px solid #e7ebf1;border-radius:1rem;box-shadow:0 .65rem 1.3rem rgba(15,23,42,.07)}
...
<section class="py-4 catalogo-filtros" id="catalogoProductos">
  <div class="container">
    <div class="catalogo-filtros__card bg-white p-3 p-lg-4 mb-3">
      <form class="row g-2 mb-0" method="GET" id="catalogoFiltros">
        <div class="col-12 col-lg-5"><input class="form-control" name="q" value="<?= e($buscar) ?>" placeholder="Buscar producto o servicio"></div>
        ...
        <div class="col-12 col-lg-3"><button class="btn btn-primary w-100">Aplicar filtros</button></div>
      </form>
    </div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      <form method="POST" action="<?= e(url('/catalogo/' . (int) $empresa['id'] . '/checkout')) ?>" class="catalogo-checkout">
        <?= csrf_campo() ?>
        <div class="modal-header">
          <h5 class="modal-title">Checkout seguro</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
        </div>
        <div class="modal-body">
          <div class="catalogo-checkout__block mb-3 bg-light-subtle">
            <div class="catalogo-checkout__title">Resumen de compra</div>
          ...
          <div class="catalogo-checkout__block mb-3">
            <div class="catalogo-checkout__title">Datos del comprador</div>
            <div class="row g-2">
          ...
          <div class="catalogo-checkout__block">
            <div class="catalogo-checkout__title">Dirección de envío y facturación</div>
            <div class="row g-2">
              ...
              <div class="col-md-6"><label class="form-label">Referencia de entrega</label><input class="form-control" name="referencia" placeholder="Departamento, oficina, horario, etc."></div>
            </div>
          </div>

          <div class="form-check mt-3">
            <input class="form-check-input" type="checkbox" name="acepta_terminos" id="acepta_terminos" value="1" required>
            <label class="form-check-label small" for="acepta_terminos">
              Confirmo que los datos ingresados son correctos y acepto continuar con el pago.
            </label>
          </div>
        </div>
        <div class="modal-footer">
