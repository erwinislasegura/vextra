...
<aside class="sidebar sidebar-app p-3 border-end bg-white">
  ...
  <nav class="nav flex-column small gap-2">
    ...
    <?php if ($tieneModulo('modulo_clientes') || $tieneModulo('modulo_contactos') || $tieneModulo('modulo_vendedores') || $tieneModulo('modulo_cotizaciones') || $tieneModulo('modulo_seguimiento') || $tieneModulo('modulo_aprobaciones') || $tieneModulo('modulo_catalogo_en_linea') || $tieneModulo('modulo_compras_catalogo')): ?>
    ...
    <?php if ($tieneModulo('modulo_compras_catalogo')): ?><a class="nav-link d-flex gap-2 <?= $coincideRuta('/app/compras-catalogo', $rutaActual) ? 'active' : '' ?>" href="<?= e(url('/app/compras-catalogo')) ?>"><i class="bi bi-bag-check mt-1"></i><span>Compras catálogo</span></a><?php endif; ?>
    ...
    <?php if ($tieneModulo('modulo_documentos') || $tieneModulo('modulo_correos_stock') || $tieneModulo('modulo_configuracion') || $tieneModulo('modulo_checkout_flow') || $tieneModulo('modulo_usuarios') || $tieneModulo('modulo_notificaciones') || $tieneModulo('modulo_historial') || $tieneModulo('modulo_reportes')): ?>
    ...
    <?php if ($tieneModulo('modulo_configuracion')): ?><a class="nav-link d-flex gap-2 align-items-center <?= $coincideRuta('/app/configuracion', $rutaActual) ? 'active' : '' ?>" href="<?= e(url('/app/configuracion/dominio-catalogo')) ?>"><i class="bi bi-globe2 mt-1"></i><span>Dominio catálogo</span><small class="ms-auto badge <?= $incluyeDominioCatalogo ? 'text-bg-success' : 'text-bg-secondary' ?>"><?= $incluyeDominioCatalogo ? 'Incluido' : 'No incluido' ?></small></a><?php endif; ?>
    <?php if ($tieneModulo('modulo_checkout_flow')): ?><a class="nav-link d-flex gap-2 <?= $coincideRuta('/app/pagos/checkout-flow', $rutaActual) ? 'active' : '' ?>" href="<?= e(url('/app/pagos/checkout-flow')) ?>"><i class="bi bi-credit-card-2-front mt-1"></i><span>Checkout Flow</span></a><?php endif; ?>
