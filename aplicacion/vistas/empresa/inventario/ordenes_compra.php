...
<div class="card mt-3">
    ...
    <div class="d-flex flex-wrap gap-2 align-items-center">
      ...
      <form method="GET" class="d-flex gap-2">
        ...
        <select name="estado" class="form-select form-select-sm" style="min-width: 220px;">
          ...
          <option value="recibida" <?= ($filtrosListado['estado'] ?? '') === 'recibida' ? 'selected' : '' ?>>Recibida</option>
  ...
  <div class="table-responsive" style="overflow: visible;">
    <table class="table table-sm mb-0">
      <thead>
        <tr>
          <th>Número</th><th>Proveedor</th><th>Emisión</th><th>Entrega est.</th><th>Estado</th><th>Usuario</th><th class="text-end">Acciones</th>
        </tr>
      </thead>
      <tbody>
