      ...
      <div class="card card-dashboard h-100">
        ...
        <div class="card-body">
          <div class="row g-2 panel-kpi-grid">
            <div class="col-sm-6 col-xl-3" data-kpi-module="inventario"><div class="panel-inline-stat panel-inline-stat--sky h-100"><div class="small text-muted">Órdenes de compra pendientes</div><div class="h5 mb-0"><?= (int) ($resumen['ordenes_compra_pendientes'] ?? 0) ?></div></div></div>
            <div class="col-sm-6 col-xl-3" data-kpi-module="comercial"><div class="panel-inline-stat panel-inline-stat--green h-100"><div class="small text-muted">Seguimientos abiertos</div><div class="h5 mb-0"><?= (int) ($resumen['seguimientos_abiertos'] ?? 0) ?></div></div></div>
            <div class="col-sm-6 col-xl-3" data-kpi-module="comercial"><div class="panel-inline-stat panel-inline-stat--red h-100"><div class="small text-muted">Notificaciones por revisar</div><div class="h5 mb-0"><?= (int) ($resumen['notificaciones_pendientes'] ?? 0) ?></div></div></div>
            ...
            <div class="col-sm-6 col-xl-3" data-kpi-module="comercial"><div class="panel-inline-stat panel-inline-stat--amber h-100"><div class="small text-muted">Aprobaciones pendientes</div><div class="h5 mb-0"><?= $aprobacionesPendientes ?></div></div></div>
          </div>
        </div>
      </div>
    </div>
