          ...
          <form method="POST" class="row g-3" data-recaptcha-form="1" data-recaptcha-action="registro_empresa">
            ...
            <div class="col-12">
              <div class="alert alert-info mb-2">
                Al completar tu registro tendrás <strong>30 días de prueba gratis!!</strong> No se te cobrará hoy ni se pedirá pago inmediato. El pago ecommerce se solicitará al finalizar la prueba.
              </div>
            ...
            <div class="col-12">
              <div class="form-check">
                ...
                <label class="form-check-label" for="acepta_terminos">
                  Acepto los términos y condiciones del servicio y entiendo que el cobro ecommerce se solicitará al finalizar los 30 días gratis.
                </label>
              </div>
            </div>

            <div class="col-12 d-grid d-md-flex justify-content-md-end pt-2">
              <button type="submit" class="btn btn-primary px-4">Crear empresa y activar 30 días gratis</button>
            </div>
          </form>
        </div>
      </div>
